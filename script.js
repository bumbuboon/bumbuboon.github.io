document.addEventListener('DOMContentLoaded', () => {
    ...
    const content = {
        ...
        jp: {
            ...
            researchTitle: '研究内容',
            researchContent: `            selfIntroText: '今年度中の起業を目指しており、現在様々なアイディアを検証中です。自ら事業を立ち上げる力は、自分のMissionである「好奇心と社会貢献を両立すること」を実現する上で不可欠だと考えています。<br><br>大学では公衆衛生の幅広い分野を学びながら、AIを活用して人々の健康やウェルビーイング向上に貢献する方法を模索しています。<br><br>また、研究面では、人間の行動を大規模言語モデル（LLM）やAIを使ってシミュレーションする技術に強い関心を持っており、テクノロジーと社会が交わる領域に大きな可能性を感じています。博士課程への進学を通じ、自律的に研究を進める能力をさらに高めていきたいと思っています。',`,
            languagesTitle: '言語',
